...
- [ ] #6 README note/example: transformer-ref output is a single Arrow struct column; show the flatten step for the sklearn handoff (near-term DX; Epic A dense output / A4 assembler supersedes it long-term).
<!-- AC:END -->
