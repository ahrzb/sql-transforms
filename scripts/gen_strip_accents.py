"""Generate src/specializer/exec/strip_accents.rs by measuring DuckDB.
...
census in tests/test_duckdb_interpreter.py is the ongoing authority.
...
OUT = REPO / "src" / "specializer" / "exec" / "strip_accents.rs"
