"""Generate src/specializer/exec/casemap.rs by measuring DuckDB.
...
census in tests/test_duckdb_interpreter.py (which will fail loudly if this
table ever drifts from the duckdb the suite runs against).
...
OUT = REPO / "src" / "specializer" / "exec" / "casemap.rs"
