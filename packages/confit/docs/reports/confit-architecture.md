...
Measured concretely (packages/confit/docs/proposals/2026-07-28-columnar-path.md, titanic scenario, DuckDB handed a pre-built Arrow table each call):
...
Stage B (TASK-59, packages/confit/docs/specs/2026-07-28-stageB-multiplicity-pins.md) taught the engine 1:N joins under `shape='many'`, and required the only structural change the IR has had since M-ir: loops.
